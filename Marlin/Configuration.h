...
#define STRING_CONFIG_H_AUTHOR "(IT Services Ewald Stangl, Ender-3 Pro)" // Who made the changes.
 ...
 *                                      X, Y, Z, E0 [, E1[, E2...]]
 */
#define DEFAULT_AXIS_STEPS_PER_UNIT   { 79.75, 79.75, 405.4, 130 }
